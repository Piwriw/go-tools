...
/*
install go get github.com/jessevdk/go-flags
Example:
go run go-flag/go-flag.go  -i=10
go run go-flag/go-flag.go  --boolslice false
go run go-flag/go-flag.go  --boolslice false --boolslice false
go run go-flag/go-flag.go  -i 10 -s "stringstring"
