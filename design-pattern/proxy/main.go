...
func (ks *KoreaShopping) Sell(goods *Goods) {
	fmt.Println("Korea Sell", goods.Kind)
}
...
type EnglishShopping struct{}

func (es *EnglishShopping) Buy(goods *Goods) {
...
func (op *OverseasProxy) Sell(goods *Goods) {
	//TODO implement me
	op.shopping.Sell(goods)
}
